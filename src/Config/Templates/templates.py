...
LEASE_AGREEMENT_CONSTANTS = {
    ...
    "Aircraft Type": "Type of Aircraft. It's necessarily!!",
    ...
    "Engines Manufacture": "Engines manufacture's name. May be locate in 'Engines' block or same. Use None if not provided",
    ...
    "Engine2 MSN": "Engine No.2 MSN. Other field names: Engine Serial Number, Engine Serial No, Engine Manufacture Serial Number. "
                   "May be locate in 'Engines' block or same, if not defined - use None, if it is mentioned that the field refers to another file, you must specify the file name.",
    "Aircraft Registration": "Aircraft registration number. If not defined - use None, if it is mentioned that the field refers to another file, you must specify the file name.",
    "Dated": "The date the agreement was signed",
    "Lessee": "Lessee is described at the beginning of the file. If not defined - use None",
    "Lessor": "Lessor is described at the beginning of the file. If not defined - use None",
